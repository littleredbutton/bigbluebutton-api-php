 ...
 * @method string|null getErrorRedirectUrl()
 ...
 * @method string|null getEnforceLayout()
 * @method $this       setEnforceLayout(MeetingLayout $enforceLayout)
 * @method string|null getWebcamBackgroundURL()
